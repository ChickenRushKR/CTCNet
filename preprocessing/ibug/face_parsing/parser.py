...
# import roi_tanh_warping.reference_impl as ref
# from .rtnet import rtnet50, rtnet101, FCN
from .rtnet.rtnet import rtnet50, rtnet101, FCN
...
class FaceParser(object):
    def __init__(self, device='cuda', ckpt=None, encoder='rtnet50', decoder='fcn', num_classes=11):
        self.device = device
    ...
    def predict_img(self, img, bboxes, rgb=False):
        ...
        # for imgXXX in imgs:
        #     cv2.imshow("resize Image", imgXXX)
        #     key1 = cv2.waitKey(0)
        #     if key1 == ord('q') or key1 == ord('Q'):
